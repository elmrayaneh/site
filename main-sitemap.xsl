			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>موقعیت نقشه سایت - علم رایانه</title>
					</xsl:when>
					<xsl:otherwise>
						<title>نقشه سایت XML - علم رایانه</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>پرونده KML</h1>
															...
															<p>
									پرونده KML توسط <a href="https://s.rankmath.com/home" target="_blank">Rank Math افزونه سئو وردپرس</a> ایجاد شده است. برای ارائه اطلاعات مکان به Google استفاده می شود.								</p>
							
							<p>
								درباره <a href="https://developers.google.com/kml/documentation/" target="_blank">KML File</a> بیشتر بدانید.							</p>
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://elmrayaneh.ir/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
