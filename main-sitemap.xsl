					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>پرونده KML</h1>
															...
															<p>
									پرونده KML توسط <a href="https://rankmath.com/" target="_blank">Rank Math افزونه سئو وردپرس</a> ایجاد شده است. برای ارائه اطلاعات مکان به Google استفاده می شود.								</p>
